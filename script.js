window.onload = function () {
  ...
  function handleScroll(playing1) {
    ...
    console.log('playing ' . playing1);
    if (scrollPosition >= 34500 && scrollPosition < 45500 && !playing1) {
      playAudio('#Chap2TAudio');
      playing1 = true;
    }
    ...
    if (scrollPosition >= 45500) {
      playAudio('#Chap3TAudio');
      playing1 = false;
  ...
  document.body.addEventListener('scroll', function () {
    playAudio('#Chap2TAudio');
    // Remove the click event listener after the first click to avoid multiple plays
    document.body.removeEventListener('scroll', arguments.callee);
  });
  document.body.addEventListener('scroll', function () {
    playAudio('#Chap3TAudio');
    // Remove the click event listener after the first click to avoid multiple plays
  ...
  document.body.addEventListener('scroll', function () {
    playAudio('#Chap4TAudio');
    // Remove the click event listener after the first click to avoid multiple plays
    document.body.removeEventListener('scroll', arguments.callee);
  });
  document.body.addEventListener('scroll', function () {
    playAudio('#Chap5TAudio');
    // Remove the click event listener after the first click to avoid multiple plays
    document.body.removeEventListener('scroll', arguments.callee);
  });
